...
2. `op!` scope is correctly found when treated as argument. Arguments highlighting for `op!` itself is TBD (Partly done 17.01)
...
8. No comments :). TBD
9. No code execution. Also incremental execution TBD. (First draft done 18.01)
